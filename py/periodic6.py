# periodic6.py 29 Nov 2013
# parses topotime_format, Dance, Pleiades
# now build geometries
...
data = 'topotime_format' 
# topotime_format pleiades98test Dance us_history ww2; INTERIM tests: ttspec pleiades_fuzz98 
...
def writeEm():
   ...
   fnpickle=wd+'data/'+data+'.pickle'
   w4=codecs.open(fnpickle,"w")   
   
   per=newCollection['periods'][2]; # g=per['geom'][1]
